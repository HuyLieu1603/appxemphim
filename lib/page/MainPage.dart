...
class _StateMainPageWidget extends State<MainPage>{
  ...
  Widget build(BuildContext context){
    return Container(
      ...
      image:DecorationImage(image: AssetImage('assets/images/MainPage/mainpage.png'), // se co update lay theo dia chi link
      ...
      child: Container(
        decoration: BoxDecoration(
            ...
            gradient:  LinearGradient(
                colors: [Colors.transparent.withOpacity(0.1), Colors.black.withOpacity(1)],
                stops: [0,0.8],
